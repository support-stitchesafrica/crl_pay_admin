  ...
  const fetchData = async () => {
    try {
      ...
      const [loansData, statsData] = await Promise.all([
        getLoans({ status: statusFilter === 'all' ? undefined : statusFilter }),
        getMerchantLoanStats(),
      ]);
      setLoans(loansData);
      setStats(statsData);
    } catch (error: any) {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Manage and monitor all your customer loans</p>
      </div>
